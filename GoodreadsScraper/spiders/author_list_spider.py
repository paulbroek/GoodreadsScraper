...
class AuthorListSpider(scrapy.Spider):
    """Extract URLs of books from a list of books by author

    example list: https://www.goodreads.com/author/list/4562806.Dan_S_Kennedy
